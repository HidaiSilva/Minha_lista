...
namespace MinhaLista
{
    ...
    public partial class MinhaLista : Form
    {
        ...
        private void historicoDePedidosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            HistóricoPedido histped = new HistóricoPedido();
            histped.ShowDialog();
        }
        ...
        private void fornecedorResponsavelToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            FornecedorResponsavel altforn = new FornecedorResponsavel();
            altforn.ShowDialog();
        }
